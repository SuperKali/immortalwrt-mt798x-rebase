...
define Device/acer_predator-w6x-stock
  ...
  KERNEL_IN_UBI := 1
  UBOOTENV_IN_UBI := 1
  DEVICE_PACKAGES := kmod-usb3 kmod-leds-ws2812b automount
  IMAGES := sysupgrade.bin
  KERNEL := kernel-bin | lzma | fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb
  KERNEL_INITRAMFS := kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd | pad-to 64k
...
define Device/acer_vero-w6m
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_DTS_LOADADDR := 0x47000000
  DEVICE_PACKAGES := kmod-leds-ktd202x     e2fsprogs f2fsck mkf2fs
  IMAGES := sysupgrade.bin
  KERNEL := kernel-bin | lzma | fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb
  KERNEL_INITRAMFS := kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd | pad-to 64k
...
define Device/aigo_ags21
  ...
  ARTIFACT/emmc-bl31-uboot.fip := mt7981-bl31-uboot aigo_ags21
endef
...
define Device/bananapi_bpi-r3
  ...
  DEVICE_DTS_LOADADDR := 0x43f00000
  DEVICE_PACKAGES := kmod-hwmon-pwmfan kmod-i2c-gpio   kmod-sfp \
		     kmod-usb3 f2fsck mkf2fs  automount
  IMAGES := sysupgrade.itb
  KERNEL_LOADADDR := 0x44000000
  KERNEL_INITRAMFS_SUFFIX := -recovery.itb
  ARTIFACTS := \
...
define Device/dlink_aquila-pro-ai-m30-a1
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-leds-gca230718 
  KERNEL_IN_UBI := 1
  IMAGE_SIZE := 51200k
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
ifeq ($(IB),)
...
define Device/iptime_ax3000se
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
  DEVICE_PACKAGES := kmod-ledtrig-network
  SUPPORTED_DEVICES += mediatek,mt7981-spim-snand-rfb
endef
...
define Device/teltonika_rutc50
  ...
  KERNEL_IN_UBI := 1
  UBINIZE_OPTS := -E 5
  DEVICE_PACKAGES :=    kmod-usb3 kmod-usb-net-qmi-wwan \
...
define Device/tplink_archer-ax80-v1
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-leds-lp5523 kmod-usb3  \
	  automount
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define Device/tplink_fr365-v1
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
  DEVICE_PACKAGES := fitblk kmod-sfp kmod-usb3 automount
endef
...
define Device/tplink_tl-xdr-common
  ...
  IMAGE/sysupgrade.itb := append-kernel | \
	fit gzip $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb external-with-rootfs | append-metadata
  DEVICE_PACKAGES := fitblk kmod-usb3    automount
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := mt7986-bl2 spim-nand-ddr3
endef
...
define Device/ubnt_unifi-6-plus
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES :=  e2fsprogs f2fsck mkf2fs fdisk partx-utils
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
...
define Device/unielec_u7981-01
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES :=  kmod-usb3 f2fsck mkf2fs fdisk partx-utils automount
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
...
define Device/wavlink_wl-wn536ax6-a
  ...
  KERNEL_INITRAMFS_SUFFIX := .itb
  KERNEL_IN_UBI := 1
  DEVICE_PACKAGES := kmod-ledtrig-network kmod-usb3 automount
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
...
define Device/zyxel_ex5700-telenor
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES :=   kmod-ubootenv-nvram \
	kmod-usb3   automount
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define Device/zyxel_nwa50ax-pro
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES :=  zyxel-bootconfig
  DEVICE_DTS_LOADADDR := 0x44000000
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
